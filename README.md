...
**ConsistCalc** adalah aplikasi web Trading Discipline & Growth Tracker yang dirancang untuk membantu trader prop firm mengelola, memantau, dan mengevaluasi aktivitas trading dengan fokus pada disiplin dan manajemen risiko. Aplikasi ini merupakan **Progressive Web App (PWA)** yang dapat diinstal di perangkat dan digunakan secara offline.
...
- **PWA (Progressive Web App)**: Dapat diinstal dan digunakan secara offline

## Cara Menjalankan Aplikasi

### Metode 1: Langsung di Browser (Disarankan)

1. Buka website ConsistCalc di browser (Chrome, Firefox, Edge, Safari)
2. Aplikasi siap digunakan!

### Metode 2: Instal sebagai Aplikasi (PWA)

Setelah membuka aplikasi di browser yang mendukung PWA (Chrome, Edge):

1. Klik tombol **Install** atau ikon instalasi di address bar
2. Aplikasi akan terinstall dan dapat diakses dari layar utama perangkat
3. Aplikasi dapat digunakan secara **offline** tanpa koneksi internet

### Metode 3: Local Server (Untuk pengembangan)
...
- **Web App Manifest** - Konfigurasi PWA untuk instalasi
